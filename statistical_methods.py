...
#Burada order ifadesine  girmiş  olduğumuz değerler arımadan  gelen trend  bileşen değerleridir.
#seasonal_order ifadesine  girmiş  olduğumuz değerler  sarımanın  bileşen değerleridir.
...
#aic değerini, trend bileşenin gecikmelerini (model derecelerini), mevsimsellik bileşinin model derecelerini  atayalım.
#önce trend derecelerine girecek
...
feature_predict = sarima_final_model.get_forecast(steps=6) #6 ay
